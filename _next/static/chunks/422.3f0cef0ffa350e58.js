(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [422],
  {
    ...
    11655: function (e, t) {
      ...
      t.add3L = w;
      let v = (e, t, n, r) => (t + n + r + ((e / 4294967296) | 0)) | 0;
      t.add3H = v;
      let k = (e, t, n, r) => (e >>> 0) + (t >>> 0) + (n >>> 0) + (r >>> 0);
      t.add4L = k;
      let I = (e, t, n, r, i) => (t + n + r + i + ((e / 4294967296) | 0)) | 0;
      t.add4H = I;
      let E = (e, t, n, r, i) =>
        (e >>> 0) + (t >>> 0) + (n >>> 0) + (r >>> 0) + (i >>> 0);
      t.add5L = E;
    ...
    33847: function (e, t, n) {
      ...
      function L(e, t, n, r, s, a, o, c, l, u, d) {
        ...
        for (
                ...
                null != (c = n[a]) &&
                  ...
                  (function e(t, n, r) {
                    ...
                    if (
                      ...
                      (s = t.ref) &&
                        ((s.current && s.current !== t.__e) || O(s, null, n)),
                      null != (s = t.__c))
                    ) {
          ...
          null != (f = n.__k[h]) &&
            ...
            f.ref &&
              p.ref != f.ref &&
              (p.ref && O(p.ref, null, f), d.push(f.ref, f.__c || g, f)),
            null == y && null != g && (y = g),
            4 & f.__u || p.__k === f.__k
              ? (l = (function e(t, n, r) {
                  var i, s;
          ...
          try {
            ...
            (p.state = p.__s),
              ...
              E &&
                ...
                (y = p.getSnapshotBeforeUpdate(g, _)),
              (O = h),
              null != h &&
                h.type === C &&
                null == h.key &&
              ...
              (l = L(e, b(O) ? O : [O], t, n, s, a, o, c, l, u, d)),
              (p.base = t.__e),
              (t.__u &= -161),
      ...
      function T(e, t, n) {
        for (var r = 0; r < n.length; r++) O(n[r], n[++r], n[++r]);
        i.__c && i.__c(t, e),
          e.some(function (t) {
            try {
              (e = t.__h),
      ...
      function q(e, t, n) {
        ...
        return (
          ...
          I(e.type, c, i || e.key, s || e.ref, null)
        );
      }
      function B(e) {
        function t(e) {
    ...
    34619: function (e, t, n) {
      ...
      function L() {
        for (var e; (e = l.shift()); )
          if (e.__P && e.__H)
            try {
              e.__H.__h.forEach(N), e.__H.__h.forEach(D), (e.__H.__h = []);
            } catch (t) {
        ...
        (u.__r = function (e) {
          ...
          t &&
            (s === i
              ...
              : (t.__h.forEach(N), t.__h.forEach(D), (t.__h = []), (r = 0))),
            (s = i);
        }),
        (u.diffed = function (e) {
          p && p(e);
    ...
    21084: function (e, t, n) {
      var r = n(48834).Buffer;
      let { keccak_256: i } = n(80125);
      function s(e) {
    ...
    92422: function (e, t, n) {
      ...
      function W(e) {
        if ("string" == typeof e) {
          let t = T(e).toLowerCase();
          if (j(t) && 40 === t.length) return b(O(t));
        }
      ...
      function B(e) {
        ...
        if ("string" == typeof e) {
          ...
          if (j(e)) return v(Number(BigInt(U(e, !0))));
        }
      ...
      function H(e) {
        ...
        if ("number" == typeof e) return BigInt(B(e));
        if ("string" == typeof e) {
          if (C.test(e)) return BigInt(e);
          if (j(e)) return BigInt(U(e, !0));
        }
        throw h.rpc.invalidParams(`Not an integer: ${String(e)}`);
      }
      async function z() {
          ...
          return (
            ...
            (i !== this.chain &&
              ...
              null === (n = this.callback) ||
                void 0 === n ||
                n.call(this, "chainChanged", D(i.id))),
            !0)
          );
        }
      }
        ...
        async decrypt(e) {
          ...
          return new Promise((n, r) => {
            !(async function () {
              ...
              try {
                let e = await window.crypto.subtle.decrypt(u, i, l),
                  t = new TextDecoder();
                n(t.decode(e));
              } catch (e) {
                r(e);
      ...
      class eI {
        ...
        static load(e) {
          let t = e.getItem(ew),
            n = e.getItem(ek),
            r = e.getItem(ev);
          return t && r ? new eI(e, t, r, "1" === n) : null;
        }
        get linked() {
          return this._linked;
        }
              ...
              (0, ex.h)(
                ...
                (0, ex.h)(
                  ...
                  Array.from(this.items.entries()).map(([e, t]) =>
                    (0, ex.h)(eP, Object.assign({}, t, { key: e }))
                  )
                )
              ),
              this.root
      ...
      let eL = (e) =>
          (0, ex.h)(
            "div",
            { class: (0, eS.clsx)("-cbwsdk-snackbar-container") },
            (0, ex.h)(
              "style",
              null,
        ...
        eP = ({ autoExpand: e, message: t, menuItems: n }) => {
          let [r, i] = (0, eM.useState)(!0),
      ...
      class ej {
          ...
          (this.chainCallbackParams = { chainId: "", jsonRpcUrl: "" }),
            ...
            (this.accountUpdated = (e) => {
              this.accountsCallback && this.accountsCallback([e]),
                ej.accountRequestCallbackIds.size > 0 &&
                  (Array.from(ej.accountRequestCallbackIds.values()).forEach(
                    (t) => {
                  ...
                  ej.accountRequestCallbackIds.clear());
            }),
        ...
        subscribe() {
          let e = eI.load(this.storage) || eI.create(this.storage),
            ...
            r = this.isMobileWeb ? new eO() : new eN();
        ...
        submitEthereumTransaction(e, t) {
          return this.sendRequest({
            ...
            params: { signedTransaction: L(e, !0), chainId: t },
          });
        }
        ...
        handleWeb3ResponseMessage(e, t) {
          if ("requestEthereumAccounts" === t.method) {
            ej.accountRequestCallbackIds.forEach((e) =>
        ...
        requestEthereumAccounts() {
          ...
          return new Promise((e, t) => {
            this.relayEventManager.callbacks.set(r, (n) => {
              ...
              ej.accountRequestCallbackIds.add(r),
      ...
      ej.accountRequestCallbackIds = new Set();
      var eU = n(48834).Buffer;
      ...
      class eB {
        constructor(e) {
          (this._relay = null),
            (this._addresses = []),
            (this.metadata = e.metadata),
            (this._storage = new i("walletlink", eT)),
        ...
        _prepareTransactionParams(e) {
          ...
          let n = e.to ? W(e.to) : null,
            r = null != e.value ? H(e.value) : BigInt(0),
            i = e.data ? q(e.data) : eU.alloc(0),
            s = null != e.nonce ? B(e.nonce) : null,
            a = null != e.gasPrice ? H(e.gasPrice) : null,
            o = null != e.maxFeePerGas ? H(e.maxFeePerGas) : null;
          return {
            fromAddress: t,
            toAddress: n,
            weiValue: r,
            ...
            maxPriorityFeePerGas:
              null != e.maxPriorityFeePerGas ? H(e.maxPriorityFeePerGas) : null,
            gasLimit: null != e.gas ? H(e.gas) : null,
            chainId: e.chainId ? B(e.chainId) : this.getChainId(),
          };
        }
        async ecRecover(e) {
      ...
      let eH = "SignerType",
        ez = new i("CBWSDK", "SignerConfigurator");
      async function eK(e) {
        let {
          communicator: t,
          metadata: n,
      ...
      async function eF(e, t, n) {
        ...
        let r = new eB({ metadata: t, callback: n });
        e.postMessage({
...
Please see https://www.smartwallet.dev/guides/tips/popup-tips#cross-origin-opener-policy for more information.`,
        { checkCrossOriginOpenerPolicy: e$, getCrossOriginOpenerPolicy: eJ } = {
          ...
          checkCrossOriginOpenerPolicy: async () => {
            ...
            try {
              ...
              (r = null != n ? n : "null"),
                "same-origin" === r && console.error(eG);
            } catch (e) {
              console.error(
              ...
              switch (e.method) {
                case "eth_requestAccounts": {
                  let t = await this.requestSignerSelection(e),
                    n = this.initSigner(t);
                  await n.handshake(e), (this.signer = n), ez.setItem(eH, t);
                  break;
                }
                case "wallet_sendCalls": {
        ...
        initSigner(e) {
          return (function (e) {
            ...
            switch (t) {
              ...
              case "walletlink":
                return new eB({ metadata: n, callback: i });
            }
          })({
            signerType: e,
            metadata: this.metadata,
      ...
      function e1(e) {
        var t;
        new i("CBWSDK").setItem("VERSION", en), e$();
        let n = {
          metadata: {
