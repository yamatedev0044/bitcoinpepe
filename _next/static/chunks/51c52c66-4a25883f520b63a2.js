...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [999],
  {
    27158: function (e, t, r) {
      ...
      function x(e) {
        try {
          return c.UN.ExtendedPoint.fromHex(e), !0;
        } catch {
          return !1;
        }
      }
      let v = (e, t) => c.UN.sign(e, t.slice(0, 32)),
        B = c.UN.verify,
        R = (e) =>
          a.Buffer.isBuffer(e)
            ? e
            : e instanceof Uint8Array
            ? a.Buffer.from(e.buffer, e.byteOffset, e.byteLength)
            : a.Buffer.from(e);
      class P {
        constructor(e) {
        ...
        encode() {
          return a.Buffer.from((0, p.serialize)(E, this));
        }
        static decode(e) {
          return (0, p.deserialize)(E, this, e);
        }
        static decodeUnchecked(e) {
          return (0, p.deserializeUnchecked)(E, this, e);
        }
      }
      let E = new Map(),
        T = 1;
      ...
      (W.default = new W("11111111111111111111111111111111")),
        E.set(W, { kind: "struct", fields: [["_bn", "u256"]] }),
      ...
      let z = (e = "publicKey") => f.Ik(32, e),
        O = (e = "signature") => f.Ik(64, e),
        N = (e = "string") => {
          let t = f.n_(
              [
                f.Jq("length"),
                f.Jq("lengthPadding"),
                f.Ik(f.cv(f.Jq(), -8), "chars"),
              ],
              e
            ),
            r = t.decode.bind(t),
          ...
          return (
            ...
            (t.encode = (e, t, r) =>
              i({ chars: a.Buffer.from(e, "utf8") }, t, r)),
            (t.alloc = (e) =>
              f.Jq().span + f.Jq().span + a.Buffer.from(e, "utf8").length),
            t
          );
        };
      function j(e) {
        ...
        drainKeysFoundInLookupTable(e, t) {
          ...
          for (let [s, n] of this.keyMetaMap.entries())
            if (t(n)) {
              ...
              n >= 0 &&
                (M(n < 256, "Max lookup table index exceeded"),
                r.push(n),
                i.push(t),
        ...
        serialize() {
          ...
          r.forEach((e) => {
            let t = f
              .n_([
                f.u8("programIdIndex"),
                f.Ik(e.keyIndicesCount.length, "keyIndicesCount"),
                f.A9(f.u8("keyIndex"), e.keyIndices.length, "keyIndices"),
                f.Ik(e.dataLength.length, "dataLength"),
                f.A9(f.u8("userdatum"), e.data.length, "data"),
              ])
              .encode(e, s, n);
            n += t;
          }),
            (s = s.slice(0, n));
          let o = f.n_([
              f.Ik(1, "numRequiredSignatures"),
              f.Ik(1, "numReadonlySignedAccounts"),
              f.Ik(1, "numReadonlyUnsignedAccounts"),
              f.Ik(t.length, "keyCount"),
              f.A9(z("key"), e, "keys"),
              z("recentBlockhash"),
            ]),
            c = {
              numRequiredSignatures: a.Buffer.from([
                this.header.numRequiredSignatures,
              ]),
              numReadonlySignedAccounts: a.Buffer.from([
                this.header.numReadonlySignedAccounts,
              ]),
              numReadonlyUnsignedAccounts: a.Buffer.from([
                this.header.numReadonlyUnsignedAccounts,
              ]),
        ...
        static from(e) {
          ...
          for (let e = 0; e < u; e++) {
            let e = $(t),
              ...
              s = j(t),
              n = X(t, 0, s),
              o = h().encode(a.Buffer.from(n));
            l.push({ programIdIndex: e, accounts: i, data: o });
          }
          return new F({
            header: {
      ...
      class H {
        ...
        static compile(e) {
          ...
          let [s, n] = t.getMessageComponents(),
            o = new U(n, i).compileInstructions(e.instructions);
          return new H({
            header: s,
            staticAccountKeys: n,
            recentBlockhash: e.recentBlockhash,
        ...
        serialize() {
          let e = [];
          G(e, this.staticAccountKeys.length);
          let t = this.serializeInstructions(),
            r = [];
          G(r, this.compiledInstructions.length);
          let i = this.serializeAddressTableLookups(),
            s = [];
          G(s, this.addressTableLookups.length);
          let n = f.n_([
              f.u8("prefix"),
              f.n_(
                [
              ...
              f.Ik(e.length, "staticAccountKeysLength"),
              f.A9(z(), this.staticAccountKeys.length, "staticAccountKeys"),
              z("recentBlockhash"),
              f.Ik(r.length, "instructionsLength"),
              f.Ik(t.length, "serializedInstructions"),
              f.Ik(s.length, "addressTableLookupsLength"),
              f.Ik(i.length, "serializedAddressTableLookups"),
            ]),
        ...
        serializeInstructions() {
          ...
          for (let r of this.compiledInstructions) {
            let i = [];
            G(i, r.accountKeyIndexes.length);
            let s = [];
            G(s, r.data.length);
            let n = f.n_([
              f.u8("programIdIndex"),
              f.Ik(i.length, "encodedAccountKeyIndexesLength"),
              f.A9(f.u8(), r.accountKeyIndexes.length, "accountKeyIndexes"),
              f.Ik(s.length, "encodedDataLength"),
              f.Ik(r.data.length, "data"),
            ]);
            e += n.encode(
              {
        ...
        serializeAddressTableLookups() {
          ...
          for (let r of this.addressTableLookups) {
            let i = [];
            G(i, r.writableIndexes.length);
            let s = [];
            G(s, r.readonlyIndexes.length);
            let n = f.n_([
              z("accountKey"),
              f.Ik(i.length, "encodedWritableIndexesLength"),
              f.A9(f.u8(), r.writableIndexes.length, "writableIndexes"),
              f.Ik(s.length, "encodedReadonlyIndexesLength"),
              f.A9(f.u8(), r.readonlyIndexes.length, "readonlyIndexes"),
            ]);
            e += n.encode(
              {
        ...
        static deserialize(e) {
          let t = [...e],
            r = $(t),
            i = 127 & r;
          M(r !== i, "Expected versioned message but received legacy message"),
            M(
              0 === i,
          ...
          let s = {
            ...
            n = [],
            o = j(t);
          for (let e = 0; e < o; e++) n.push(new W(X(t, 0, 32)));
          let a = h().encode(X(t, 0, 32)),
            c = j(t),
            u = [];
          for (let e = 0; e < c; e++) {
            let e = $(t),
      ...
      let D = {
          ...
          deserialize: (e) => {
            ...
            if ("legacy" === t) return F.from(e);
            if (0 === t) return H.deserialize(e);
            throw Error(
      ...
      class ee {
          ...
          return (
            e.forEach((e) => {
              "instructions" in e
                ...
                : this.instructions.push(new Y(e));
            }),
            this
          );
        }
        compileMessage() {
          ...
          t.forEach((e) => {
            ...
            i.forEach((e) => {
              s.push({ pubkey: new W(e), isSigner: !1, isWritable: !1 });
            });
          let n = [];
          s.forEach((e) => {
...
Missing signature for public key${
        ...
        _serialize(e) {
          ...
          return (
            M(t.length < 256),
            a.Buffer.from(r).copy(s, 0),
            t.forEach(({ signature: e }, t) => {
              null !== e &&
                (M(64 === e.length, "signature has invalid length"),
                a.Buffer.from(e).copy(s, r.length + 64 * t));
            }),
            e.copy(s, r.length + 64 * t.length),
            M(s.length <= 1232, `Transaction too large: ${s.length} > 1232`),
            s
          );
        }
        get keys() {
          return (
            M(1 === this.instructions.length),
            this.instructions[0].keys.map((e) => e.pubkey)
          );
        }
        get programId() {
          return (
            M(1 === this.instructions.length), this.instructions[0].programId
          );
        }
        get data() {
        ...
        static populate(e, t = []) {
          ...
          return (
            ...
            t.forEach((t, i) => {
              let s = {
                signature: t == h().encode(Q) ? null : h().decode(t),
      ...
      class et {
        ...
        static decompile(e, t) {
          ...
          for (let e of i) {
            ...
            h.push(new Y({ programId: i, data: R(e.data), keys: t }));
          }
          return new et({ payerKey: d, instructions: h, recentBlockhash: s });
        }
      ...
      class er {
        ...
        serialize() {
          let e = this.message.serialize(),
            t = [];
          G(t, this.signatures.length);
          let r = f.n_([
              f.Ik(t.length, "encodedSignaturesLength"),
              f.A9(O(), this.signatures.length, "signatures"),
              f.Ik(e.length, "serializedMessage"),
            ]),
        ...
        static deserialize(e) {
          let t = [...e],
            r = [],
            i = j(t);
          for (let e = 0; e < i; e++) r.push(new Uint8Array(X(t, 0, C)));
          return new er(D.deserialize(new Uint8Array(t)), r);
        }
        sign(e) {
          ...
          for (let i of e) {
            ...
            M(
              ...
              (this.signatures[e] = v(t, i.secretKey));
          }
        }
        addSignature(e, t) {
      ...
      let ei = new W("SysvarC1ock11111111111111111111111111111111");
      new W("SysvarEpochSchedu1e111111111111111111111111"),
        new W("Sysvar1nstructions1111111111111111111111111");
      let es = new W("SysvarRecentB1ockHashes11111111111111111111"),
        en = new W("SysvarRent111111111111111111111111111111111");
      new W("SysvarRewards111111111111111111111111111111"),
        new W("SysvarS1otHashes111111111111111111111111111"),
        new W("SysvarS1otHistory11111111111111111111111111");
      let eo = new W("SysvarStakeHistory1111111111111111111111111");
...
` +
      ...
      let eh = f._O("lamportsPerSignature"),
        eg = f.n_([
          f.Jq("version"),
          f.Jq("state"),
          z("authorizedPubkey"),
          z("nonce"),
          f.n_([eh], "feeCalculator"),
        ]),
        ep = eg.span;
      class ef {
        constructor(e) {
      ...
      let em = (e) => ({ decode: e.decode.bind(e), encode: e.encode.bind(e) }),
        eb = (e) => {
          let t = (0, f.Ik)(8, e),
            { encode: r, decode: i } = em(t);
          return (
            (t.decode = (e, t) => {
              let r = i(e, t);
              return (0, m.oU)(a.Buffer.from(r));
            }),
            (t.encode = (e, t, i) => r((0, m.k$)(e, 8), t, i)),
            t
          );
        },
        ey = Object.freeze({
          ...
          Assign: {
            index: 1,
            layout: f.n_([f.Jq("instruction"), z("programId")]),
          },
          Transfer: {
            index: 2,
            layout: f.n_([f.Jq("instruction"), eb("lamports")]),
          },
          CreateWithSeed: {
            index: 3,
            layout: f.n_([
          ...
          AdvanceNonceAccount: {
            index: 4,
            layout: f.n_([f.Jq("instruction")]),
          },
          WithdrawNonceAccount: {
            index: 5,
            layout: f.n_([f.Jq("instruction"), f.gM("lamports")]),
          },
          InitializeNonceAccount: {
            index: 6,
            layout: f.n_([f.Jq("instruction"), z("authorized")]),
          },
          ...
          Allocate: {
            index: 8,
            layout: f.n_([f.Jq("instruction"), f.gM("space")]),
          },
          AllocateWithSeed: {
            index: 9,
            layout: f.n_([
      ...
      class ek {
        ...
        static transfer(e) {
          ...
          return (
            "basePubkey" in e
              ...
              : ((t = ed(ey.Transfer, { lamports: BigInt(e.lamports) })),
                (r = [
                  { pubkey: e.fromPubkey, isSigner: !0, isWritable: !0 },
                  { pubkey: e.toPubkey, isSigner: !1, isWritable: !0 },
                ])),
            new Y({ keys: r, programId: this.programId, data: t })
          );
        }
        static assign(e) {
          let t, r;
          return (
            "basePubkey" in e
              ...
              : ((t = ed(ey.Assign, { programId: R(e.programId.toBuffer()) })),
                (r = [
        ...
        static nonceInitialize(e) {
          let t = ed(ey.InitializeNonceAccount, {
        ...
        static nonceAdvance(e) {
          let t = ed(ey.AdvanceNonceAccount);
          return new Y({
            keys: [
              { pubkey: e.noncePubkey, isSigner: !1, isWritable: !0 },
              { pubkey: es, isSigner: !1, isWritable: !1 },
        ...
        static nonceWithdraw(e) {
          let t = ed(ey.WithdrawNonceAccount, { lamports: e.lamports });
          return new Y({
            keys: [
              { pubkey: e.noncePubkey, isSigner: !1, isWritable: !0 },
              { pubkey: e.toPubkey, isSigner: !1, isWritable: !0 },
        ...
        static nonceAuthorize(e) {
          let t = ed(ey.AuthorizeNonceAccount, {
        ...
        static allocate(e) {
          ...
          return (
            "basePubkey" in e
              ...
              : ((t = ed(ey.Allocate, { space: e.space })),
                (r = [
                  { pubkey: e.accountPubkey, isSigner: !0, isWritable: !0 },
                ])),
            new Y({ keys: r, programId: this.programId, data: t })
      ...
      ek.programId = new W("11111111111111111111111111111111");
      class ew {
        constructor() {}
        ...
        static async load(e, t, r, i, s) {
          {
            ...
            if (null !== o) {
              ...
              o.data.length !== s.length &&
                (a = a || new ee()).add(
                  ek.allocate({ accountPubkey: r.publicKey, space: s.length })
                ),
                o.owner.equals(i) ||
                  (a = a || new ee()).add(
                    ek.assign({ accountPubkey: r.publicKey, programId: i })
                  ),
                o.lamports < n &&
                  (a = a || new ee()).add(
                    ek.transfer({
            ...
            null !== a && (await eu(e, a, [t, r], { commitment: "confirmed" }));
          }
          let n = f.n_([
              f.Jq("instruction"),
              f.Jq("offset"),
              f.Jq("bytesLength"),
              f.Jq("bytesLengthPadding"),
              f.A9(f.u8("byte"), f.cv(f.Jq(), -8), "bytes"),
            ]),
            o = ew.chunkSize,
            c = 0,
            u = s,
          ...
          for (; u.length > 0; ) {
            ...
            l.push(eu(e, h, [t, r], { commitment: "confirmed" })),
              e._rpcEndpoint.includes("solana.com") && (await el(250)),
              (c += o),
              (u = u.slice(o));
          }
          await Promise.all(l);
          {
            let s = f.n_([f.Jq("instruction")]),
      ...
      (ew.chunkSize = 932),
        new W("BPFLoader2111111111111111111111111111111111");
      var eS =
        (s = (function () {
          if (o) return n;
          o = 1;
      ...
      var eA = globalThis.fetch;
      class ex extends w.Ey {
        constructor(e, t, r) {
          super(
            (e) => {
              let r = (0, w.XY)(e, {
      ...
      class ev {
        ...
        static deserialize(e) {
          let t = (function (e, t) {
            ...
            r = e.length - 56;
          M(r >= 0, "lookup table is invalid"),
            M(r % 32 == 0, "lookup table is invalid");
          let { addresses: i } = f
            .n_([f.A9(z(), r / 32, "addresses")])
            .decode(e.slice(56));
          return {
      ...
      let eB = {
          ...
          layout: f.n_([
            f.Jq("typeIndex"),
            eb("deactivationSlot"),
            f._O("lastExtendedSlot"),
            f.u8("lastExtendedStartIndex"),
            f.u8(),
            f.A9(z(), f.cv(f.u8(), -1), "authority"),
          ]),
        },
        eR = /^[^:]+:\/\/([^:[]+|\[[^\]]+\])(:\d+)?(.*)/i,
        eP = (0, b.oQ)((0, b.eE)(W), (0, b.Z_)(), (e) => new W(e)),
        eE = (0, b.bc)([(0, b.Z_)(), (0, b.i0)("base64")]),
        eT = (0, b.oQ)((0, b.eE)(a.Buffer), eE, (e) =>
          a.Buffer.from(e[0], "base64")
        );
      function eW(e) {
        let t, r;
      ...
      function eq(e) {
        return (0, b.G0)([
          (0, b.dt)({ jsonrpc: (0, b.i0)("2.0"), id: (0, b.Z_)(), result: e }),
          (0, b.dt)({
            jsonrpc: (0, b.i0)("2.0"),
            id: (0, b.Z_)(),
            error: (0, b.dt)({
      ...
      let eL = eq((0, b._4)());
      function eK(e) {
        return (0, b.oQ)(eq(e), eL, (t) =>
          "error" in t ? t : { ...t, result: (0, b.Ue)(t.result, e) }
        );
      }
      function eU(e) {
        return eK(
          (0, b.dt)({ context: (0, b.dt)({ slot: (0, b.Rx)() }), value: e })
        );
      }
      function ez(e) {
        return (0, b.dt)({
          context: (0, b.dt)({ slot: (0, b.Rx)() }),
          value: e,
        });
      }
      function eO(e, t) {
      ...
      let eN = (0, b.dt)({
        ...
        eG = (0, b.IX)(
          (0, b.dt)({ slot: (0, b.Rx)(), prioritizationFee: (0, b.Rx)() })
        ),
        eM = (0, b.dt)({
          total: (0, b.Rx)(),
          validator: (0, b.Rx)(),
        ...
        e$ = (0, b.IM)((0, b.Z_)(), (0, b.IX)((0, b.Rx)())),
        eX = (0, b.AG)((0, b.G0)([(0, b.dt)({}), (0, b.Z_)()])),
        eF = (0, b.dt)({ err: eX }),
        eH = (0, b.i0)("receivedSignature"),
        eD = (0, b.dt)({
          "solana-core": (0, b.Z_)(),
        ...
        eY = eU(
          (0, b.dt)({
            ...
            innerInstructions: (0, b.jt)(
              (0, b.AG)(
                (0, b.IX)(
                  (0, b.dt)({
                    index: (0, b.Rx)(),
                    instructions: (0, b.IX)((0, b.G0)([eV, eQ])),
                  })
                )
              )
            ),
        ...
        e0 = eU(
          (0, b.dt)({
            ...
            range: (0, b.dt)({ firstSlot: (0, b.Rx)(), lastSlot: (0, b.Rx)() }),
          })
        ),
        e1 = eK(eN),
        e8 = eK(eM),
        ...
        e9 = eU(
          (0, b.dt)({
            ...
            nonCirculatingAccounts: (0, b.IX)(eP),
          })
        ),
        e7 = (0, b.dt)({
          amount: (0, b.Z_)(),
        ...
        ts = eU((0, b.IX)((0, b.dt)({ lamports: (0, b.Rx)(), address: eP }))),
        tn = (0, b.dt)({
          executable: (0, b.O7)(),
          owner: eP,
          lamports: (0, b.Rx)(),
        ...
        to = (0, b.dt)({ pubkey: eP, account: tn }),
        ta = (0, b.oQ)(
          (0, b.G0)([(0, b.eE)(a.Buffer), tr]),
          (0, b.G0)([eE, tr]),
          (e) => (Array.isArray(e) ? (0, b.Ue)(e, eT) : e)
        ),
        tc = (0, b.dt)({
          executable: (0, b.O7)(),
          owner: eP,
        ...
        tu = (0, b.dt)({ pubkey: eP, account: tc }),
        tl = (0, b.dt)({
          state: (0, b.G0)([
            (0, b.i0)("active"),
            (0, b.i0)("inactive"),
        ...
        tg = (0, b.dt)({ subscription: (0, b.Rx)(), result: ez(tn) }),
        tp = (0, b.dt)({ pubkey: eP, account: tn }),
        tf = (0, b.dt)({ subscription: (0, b.Rx)(), result: ez(tp) }),
        tm = (0, b.dt)({
          parent: (0, b.Rx)(),
          slot: (0, b.Rx)(),
          root: (0, b.Rx)(),
        }),
        tb = (0, b.dt)({ subscription: (0, b.Rx)(), result: tm }),
        ty = (0, b.G0)([
          (0, b.dt)({
            type: (0, b.G0)([
              (0, b.i0)("firstShredReceived"),
              (0, b.i0)("completed"),
              (0, b.i0)("optimisticConfirmation"),
              (0, b.i0)("root"),
            ]),
            slot: (0, b.Rx)(),
            timestamp: (0, b.Rx)(),
        ...
        tk = (0, b.dt)({ subscription: (0, b.Rx)(), result: ty }),
        tw = (0, b.dt)({
          subscription: (0, b.Rx)(),
          result: ez((0, b.G0)([eF, eH])),
        }),
        tS = (0, b.dt)({ subscription: (0, b.Rx)(), result: (0, b.Rx)() }),
        t_ = (0, b.dt)({
          pubkey: (0, b.Z_)(),
        ...
        tA = eK(
          (0, b.dt)({ current: (0, b.IX)(tI), delinquent: (0, b.IX)(tI) })
        ),
        tx = (0, b.G0)([
          (0, b.i0)("processed"),
          (0, b.i0)("confirmed"),
        ...
        tv = (0, b.dt)({
          ...
          err: eX,
          confirmationStatus: (0, b.jt)(tx),
        }),
        tB = eU((0, b.IX)((0, b.AG)(tv))),
        tR = eK((0, b.Rx)()),
        tP = (0, b.dt)({
          accountKey: eP,
        ...
        tE = (0, b.dt)({
          ...
          message: (0, b.dt)({
            ...
            addressTableLookups: (0, b.jt)((0, b.IX)(tP)),
          }),
        }),
        tT = (0, b.dt)({
          pubkey: eP,
          ...
          writable: (0, b.O7)(),
          source: (0, b.jt)(
            (0, b.G0)([(0, b.i0)("transaction"), (0, b.i0)("lookupTable")])
          ),
        }),
        tW = (0, b.dt)({
          accountKeys: (0, b.IX)(tT),
          signatures: (0, b.IX)((0, b.Z_)()),
        }),
        tC = (0, b.dt)({
          parsed: (0, b._4)(),
        ...
        tU = (0, b.oQ)(tL, tK, (e) =>
          "accounts" in e ? (0, b.Ue)(e, tq) : (0, b.Ue)(e, tC)
        ),
        tz = (0, b.dt)({
          signatures: (0, b.IX)((0, b.Z_)()),
          message: (0, b.dt)({
            accountKeys: (0, b.IX)(tT),
            instructions: (0, b.IX)(tU),
            recentBlockhash: (0, b.Z_)(),
            addressTableLookups: (0, b.jt)((0, b.AG)((0, b.IX)(tP))),
          }),
        }),
        tO = (0, b.dt)({
          accountIndex: (0, b.Rx)(),
          mint: (0, b.Z_)(),
          owner: (0, b.jt)((0, b.Z_)()),
          programId: (0, b.jt)((0, b.Z_)()),
          uiTokenAmount: e7,
        }),
        tN = (0, b.dt)({ writable: (0, b.IX)(eP), readonly: (0, b.IX)(eP) }),
        tj = (0, b.dt)({
          err: eX,
          fee: (0, b.Rx)(),
          innerInstructions: (0, b.jt)(
          ...
          preTokenBalances: (0, b.jt)((0, b.AG)((0, b.IX)(tO))),
          postTokenBalances: (0, b.jt)((0, b.AG)((0, b.IX)(tO))),
          loadedAddresses: (0, b.jt)(tN),
        ...
        tG = (0, b.dt)({
          ...
          innerInstructions: (0, b.jt)(
            (0, b.AG)(
              (0, b.IX)(
                (0, b.dt)({ index: (0, b.Rx)(), instructions: (0, b.IX)(tU) })
              )
            )
          ),
          preBalances: (0, b.IX)((0, b.Rx)()),
        ...
        tM = (0, b.G0)([(0, b.i0)(0), (0, b.i0)("legacy")]),
        tJ = (0, b.dt)({
          pubkey: (0, b.Z_)(),
          lamports: (0, b.Rx)(),
        ...
        tV = eK(
          (0, b.AG)(
            (0, b.dt)({
              ...
              parentSlot: (0, b.Rx)(),
              transactions: (0, b.IX)(
                (0, b.dt)({ transaction: tE, meta: (0, b.AG)(tj) })
              ),
              rewards: (0, b.jt)((0, b.IX)(tJ)),
              blockTime: (0, b.AG)((0, b.Rx)()),
            })
        ...
        t4 = eU(
          (0, b.AG)(
            (0, b.dt)({
              feeCalculator: (0, b.dt)({ lamportsPerSignature: (0, b.Rx)() }),
            })
          )
        ),
        t3 = eK((0, b.Z_)()),
        ...
        t7 = (0, b.dt)({ result: ez(t9), subscription: (0, b.Rx)() }),
        re = { "solana-client": "js/1.0.0-maintenance" };
      class rt {
        constructor(e, t) {
          var r, i;
          let s, n, o, a, c, u;
          (this._commitment = void 0),
            ...
            (this.getBlockHeight = (() => {
              let e = {};
              return async (t) => {
                let { commitment: r, config: i } = eW(t),
            ...
            (this._rpcWebSocket = new ex(this._rpcWsEndpoint, {
              autoconnect: !1,
              max_reconnects: 1 / 0,
            })),
        ...
        async getBalanceAndContext(e, t) {
          let { commitment: r, config: i } = eW(t),
            ...
            o = (0, b.Ue)(n, eU((0, b.Rx)()));
          if ("error" in o)
            throw new ec(o.error, `failed to get balance for ${e.toBase58()}`);
          return o.result;
        }
        ...
        async getBlockTime(e) {
          let t = await this._rpcRequest("getBlockTime", [e]),
            r = (0, b.Ue)(t, eK((0, b.AG)((0, b.Rx)())));
          if ("error" in r)
            throw new ec(r.error, `failed to get block time for slot ${e}`);
          return r.result;
        }
        async getMinimumLedgerSlot() {
          let e = await this._rpcRequest("minimumLedgerSlot", []),
            t = (0, b.Ue)(e, eK((0, b.Rx)()));
          if ("error" in t)
            throw new ec(t.error, "failed to get minimum ledger slot");
          return t.result;
        }
        async getFirstAvailableBlock() {
          let e = await this._rpcRequest("getFirstAvailableBlock", []),
            t = (0, b.Ue)(e, e6);
          if ("error" in t)
            throw new ec(t.error, "failed to get first available block");
          return t.result;
        }
        async getSupply(e) {
          let t = {};
          ...
          let r = await this._rpcRequest("getSupply", [t]),
            i = (0, b.Ue)(r, e9);
          if ("error" in i) throw new ec(i.error, "failed to get supply");
          return i.result;
        }
        async getTokenSupply(e, t) {
          let r = this._buildArgs([e.toBase58()], t),
            ...
            s = (0, b.Ue)(i, eU(e7));
          if ("error" in s) throw new ec(s.error, "failed to get token supply");
          return s.result;
        }
        async getTokenAccountBalance(e, t) {
          let r = this._buildArgs([e.toBase58()], t),
            ...
            s = (0, b.Ue)(i, eU(e7));
          if ("error" in s)
            throw new ec(s.error, "failed to get token account balance");
          return s.result;
        }
        async getTokenAccountsByOwner(e, t, r) {
          let { commitment: i, config: s } = eW(r),
            n = [e.toBase58()];
          "mint" in t
        ...
        async getLargestAccounts(e) {
          let t = { ...e, commitment: (e && e.commitment) || this.commitment },
            ...
            s = (0, b.Ue)(i, ts);
          if ("error" in s)
            throw new ec(s.error, "failed to get largest accounts");
          return s.result;
        }
        async getTokenLargestAccounts(e, t) {
          let r = this._buildArgs([e.toBase58()], t),
            ...
            s = (0, b.Ue)(i, te);
          if ("error" in s)
            throw new ec(s.error, "failed to get token largest accounts");
          return s.result;
        }
        ...
        async getMultipleParsedAccounts(e, t) {
          let { commitment: r, config: i } = eW(t),
            ...
            a = (0, b.Ue)(o, eU((0, b.IX)((0, b.AG)(tc))));
          if ("error" in a)
            throw new ec(a.error, `failed to get info for accounts ${s}`);
          return a.result;
        }
        async getMultipleAccountsInfoAndContext(e, t) {
          let { commitment: r, config: i } = eW(t),
            ...
            o = await this._rpcRequest("getMultipleAccounts", n),
            a = (0, b.Ue)(o, eU((0, b.IX)((0, b.AG)(tn))));
          if ("error" in a)
            throw new ec(a.error, `failed to get info for accounts ${s}`);
          return a.result;
        }
        ...
        async getStakeActivation(e, t, r) {
          let { commitment: i, config: s } = eW(t),
        ...
        async getProgramAccounts(e, t) {
          let { commitment: r, config: i } = eW(t),
            ...
            o = this._buildArgs([e.toBase58()], r, s || "base64", {
              ...n,
              ...(n.filters ? { filters: eC(n.filters) } : null),
            }),
            a = await this._rpcRequest("getProgramAccounts", o),
            c = (0, b.IX)(to),
            u =
              !0 === n.withContext ? (0, b.Ue)(a, eU(c)) : (0, b.Ue)(a, eK(c));
          if ("error" in u)
            throw new ec(
              u.error,
        ...
        async confirmTransaction(e, t) {
          ...
          return (M(64 === i.length, "signature has invalid length"),
          "string" == typeof e)
          ...
          let s,
            ...
            o = new Promise((t) => {
              ...
              (async () => {
                ...
                if (!n) {
                  for (; e <= r; )
                    if ((await el(1e3), n || ((e = await i()), n))) return;
                  t({ __type: V.BLOCKHEIGHT_EXCEEDED });
                }
              })();
            }),
              ...
              (async () => {
                if (((n = await c()), !a))
                  for (;;) {
                    ...
                    if ((await el(2e3), a || ((n = await c()), a))) return;
                  }
              })();
            }),
            ...
            if (t.__type === V.PROCESSED) o = t.response;
              ...
              if (i?.value) {
                ...
                switch (t) {
                  ...
                  case "single":
                  case "singleGossip":
                    if ("confirmed" !== r && "finalized" !== r) throw new K(n);
                    break;
                  case "finalized":
                  case "max":
                  case "root":
                    if ("finalized" !== r) throw new K(n);
                }
        ...
        async confirmTransactionUsingLegacyTimeoutStrategy({
          ...
          let s = new Promise((t) => {
              ...
              r = setTimeout(() => t({ __type: V.TIMED_OUT, timeoutMs: i }), i);
            }),
          ...
          try {
            ...
            else throw new L(t, e.timeoutMs / 1e3);
          } finally {
            clearTimeout(r), n();
          }
          return i;
        ...
        async getClusterNodes() {
          let e = await this._rpcRequest("getClusterNodes", []),
            t = (0, b.Ue)(e, eK((0, b.IX)(t_)));
          if ("error" in t)
            throw new ec(t.error, "failed to get cluster nodes");
          return t.result;
        }
        async getVoteAccounts(e) {
          let t = this._buildArgs([], e),
            ...
            i = (0, b.Ue)(r, tA);
          if ("error" in i)
            throw new ec(i.error, "failed to get vote accounts");
          return i.result;
        }
        async getSlot(e) {
          let { commitment: t, config: r } = eW(e),
            i = this._buildArgs([], t, void 0, r),
            s = await this._rpcRequest("getSlot", i),
            n = (0, b.Ue)(s, eK((0, b.Rx)()));
          if ("error" in n) throw new ec(n.error, "failed to get slot");
          return n.result;
        }
        async getSlotLeader(e) {
          let { commitment: t, config: r } = eW(e),
            ...
            n = (0, b.Ue)(s, eK((0, b.Z_)()));
          if ("error" in n) throw new ec(n.error, "failed to get slot leader");
          return n.result;
        }
        async getSlotLeaders(e, t) {
          let r = await this._rpcRequest("getSlotLeaders", [e, t]),
            i = (0, b.Ue)(r, eK((0, b.IX)(eP)));
          if ("error" in i) throw new ec(i.error, "failed to get slot leaders");
          return i.result;
        }
        async getSignatureStatus(e, t) {
          ...
          return M(1 === i.length), { context: r, value: i[0] };
        }
        async getSignatureStatuses(e, t) {
          ...
          let i = await this._rpcRequest("getSignatureStatuses", r),
            s = (0, b.Ue)(i, tB);
          if ("error" in s)
            throw new ec(s.error, "failed to get signature status");
          return s.result;
        }
        async getTransactionCount(e) {
          let { commitment: t, config: r } = eW(e),
            ...
            n = (0, b.Ue)(s, eK((0, b.Rx)()));
          if ("error" in n)
            throw new ec(n.error, "failed to get transaction count");
          return n.result;
        }
        ...
        async getInflationGovernor(e) {
          let t = this._buildArgs([], e),
            ...
            i = (0, b.Ue)(r, e1);
          if ("error" in i) throw new ec(i.error, "failed to get inflation");
          return i.result;
        }
        async getInflationReward(e, t, r) {
          let { commitment: i, config: s } = eW(r),
            ...
            a = (0, b.Ue)(o, ej);
          if ("error" in a)
            throw new ec(a.error, "failed to get inflation reward");
          return a.result;
        }
        async getInflationRate() {
          let e = await this._rpcRequest("getInflationRate", []),
            t = (0, b.Ue)(e, e8);
          if ("error" in t)
            throw new ec(t.error, "failed to get inflation rate");
          return t.result;
        }
        async getEpochInfo(e) {
          let { commitment: t, config: r } = eW(e),
            ...
            n = (0, b.Ue)(s, e5);
          if ("error" in n) throw new ec(n.error, "failed to get epoch info");
          return n.result;
        }
        async getEpochSchedule() {
          let e = await this._rpcRequest("getEpochSchedule", []),
            t = (0, b.Ue)(e, e4);
          if ("error" in t)
            throw new ec(t.error, "failed to get epoch schedule");
          let r = t.result;
          return new eI(
            r.slotsPerEpoch,
        ...
        async getLeaderSchedule() {
          let e = await this._rpcRequest("getLeaderSchedule", []),
            t = (0, b.Ue)(e, e3);
          if ("error" in t)
            throw new ec(t.error, "failed to get leader schedule");
          return t.result;
        }
        ...
        async getRecentPerformanceSamples(e) {
          let t = await this._rpcRequest(
            ...
            r = (0, b.Ue)(t, t5);
          if ("error" in r)
            throw new ec(r.error, "failed to get recent performance samples");
          return r.result;
        }
        async getFeeCalculatorForBlockhash(e, t) {
          let r = this._buildArgs([e], t),
            ...
            s = (0, b.Ue)(i, t4);
          if ("error" in s)
            throw new ec(s.error, "failed to get fee calculator");
        ...
        async getFeeForMessage(e, t) {
          let r = R(e.serialize()).toString("base64"),
            ...
            n = (0, b.Ue)(s, eU((0, b.AG)((0, b.Rx)())));
          if ("error" in n)
            throw new ec(n.error, "failed to get fee for message");
        ...
        async getRecentPrioritizationFees(e) {
          let t = e?.lockedWritableAccounts?.map((e) => e.toBase58()),
            ...
            s = (0, b.Ue)(i, e2);
          if ("error" in s)
            throw new ec(s.error, "failed to get recent prioritization fees");
          return s.result;
        }
        ...
        async getLatestBlockhashAndContext(e) {
          let { commitment: t, config: r } = eW(e),
            ...
            n = (0, b.Ue)(s, t1);
          if ("error" in n)
            throw new ec(n.error, "failed to get latest blockhash");
          return n.result;
        }
        ...
        async getVersion() {
          let e = await this._rpcRequest("getVersion", []),
            t = (0, b.Ue)(e, eK(eD));
          if ("error" in t) throw new ec(t.error, "failed to get version");
          return t.result;
        }
        async getGenesisHash() {
          let e = await this._rpcRequest("getGenesisHash", []),
            t = (0, b.Ue)(e, eK((0, b.Z_)()));
          if ("error" in t) throw new ec(t.error, "failed to get genesis hash");
          return t.result;
        }
        async getBlock(e, t) {
          let { commitment: r, config: i } = eW(t),
          ...
          try {
                  ...
                  ? {
                      ...
                      transactions: t.transactions.map(
                        ({ transaction: e, meta: t, version: r }) => ({
                          meta: t,
                          transaction: { ...e, message: eO(r, e.message) },
                          version: r,
                        })
                      ),
                    }
            ...
            throw new ec(e, "failed to get confirmed block");
          }
        }
        async getParsedBlock(e, t) {
          ...
          try {
            ...
            throw new ec(e, "failed to get block");
          }
        }
        async getBlockProduction(e) {
          ...
          let i = this._buildArgs([], r, "base64", t),
            ...
            n = (0, b.Ue)(s, e0);
          if ("error" in n)
            throw new ec(n.error, "failed to get block production information");
          return n.result;
        }
        async getTransaction(e, t) {
          let { commitment: r, config: i } = eW(t),
            ...
            o = (0, b.Ue)(n, tY);
          if ("error" in o) throw new ec(o.error, "failed to get transaction");
          let a = o.result;
          return a
            ? {
                ...a,
        ...
        async getParsedTransactions(e, t) {
          ...
          return (await this._rpcBatchRequest(s)).map((e) => {
            let t = (0, b.Ue)(e, t0);
            if ("error" in t)
              throw new ec(t.error, "failed to get transactions");
            return t.result;
          });
        }
        ...
        async getBlocks(e, t, r) {
          let i = this._buildArgsAtLeastConfirmed(
            ...
            n = (0, b.Ue)(s, eK((0, b.IX)((0, b.Rx)())));
          if ("error" in n) throw new ec(n.error, "failed to get blocks");
          return n.result;
        }
        async getBlockSignatures(e, t) {
          let r = this._buildArgsAtLeastConfirmed([e], t, void 0, {
            ...
            i = await this._rpcRequest("getBlock", r),
            s = (0, b.Ue)(i, tQ);
          if ("error" in s) throw new ec(s.error, "failed to get block");
          let n = s.result;
        ...
        async getConfirmedTransaction(e, t) {
          let r = this._buildArgsAtLeastConfirmed([e], t),
            ...
            s = (0, b.Ue)(i, tY);
          if ("error" in s) throw new ec(s.error, "failed to get transaction");
          let n = s.result;
          if (!n) return n;
          let o = new F(n.transaction.message),
            a = n.transaction.signatures;
          return { ...n, transaction: ee.populate(o, a) };
        }
        async getParsedConfirmedTransaction(e, t) {
          let r = this._buildArgsAtLeastConfirmed([e], t, "jsonParsed"),
            ...
            s = (0, b.Ue)(i, t0);
          if ("error" in s)
            throw new ec(s.error, "failed to get confirmed transaction");
          return s.result;
        }
        async getParsedConfirmedTransactions(e, t) {
          ...
          return (await this._rpcBatchRequest(r)).map((e) => {
            let t = (0, b.Ue)(e, t0);
            if ("error" in t)
              throw new ec(t.error, "failed to get confirmed transactions");
            return t.result;
          });
        }
        ...
        async getSignaturesForAddress(e, t, r) {
          let i = this._buildArgsAtLeastConfirmed([e.toBase58()], r, void 0, t),
            ...
            n = (0, b.Ue)(s, th);
          if ("error" in n)
            throw new ec(n.error, "failed to get signatures for address");
          return n.result;
        }
        async getAddressLookupTable(e, t) {
          ...
          return (
            null !== i &&
              (s = new ev({ key: e, state: ev.deserialize(i.data) })),
            { context: r, value: s }
          );
        }
        async getNonceAndContext(e, t) {
          let { context: r, value: i } = await this.getAccountInfoAndContext(
            ...
            s = null;
          return (
            null !== i && (s = ef.fromAccountData(i.data)),
            { context: r, value: s }
          );
        }
        async getNonce(e, t) {
        ...
        async requestAirdrop(e, t) {
          let r = await this._rpcRequest("requestAirdrop", [e.toBase58(), t]),
            i = (0, b.Ue)(r, t3);
          if ("error" in i)
            throw new ec(i.error, `airdrop to ${e.toBase58()} failed`);
          return i.result;
        }
        async _blockhashWithExpiryBlockHeight(e) {
          if (!e) {
            for (; this._pollingBlockhash; ) await el(100);
        ...
        async getStakeMinimumDelegation(e) {
          let { commitment: t, config: r } = eW(e),
            ...
            n = (0, b.Ue)(s, eU((0, b.Rx)()));
          if ("error" in n)
            throw new ec(n.error, "failed to get stake minimum delegation");
          return n.result;
        }
        async simulateTransaction(e, t, r) {
          ...
          if ("message" in e) {
            ...
            let o = await this._rpcRequest("simulateTransaction", [s, n]),
              c = (0, b.Ue)(o, eY);
            if ("error" in c)
        ...
        _wsOnAccountNotification(e) {
          let { result: t, subscription: r } = (0, b.Ue)(e, tg);
        ...
        _wsOnProgramAccountNotification(e) {
          let { result: t, subscription: r } = (0, b.Ue)(e, tf);
        ...
        onProgramAccountChange(e, t, r, i) {
          let { commitment: s, config: n } = eW(r),
            o = this._buildArgs(
              [e.toBase58()],
              s || this._commitment || "finalized",
              "base64",
              n || (i ? { filters: eC(i) } : void 0)
            );
          return this._makeSubscription(
            {
              callback: t,
        ...
        _wsOnLogsNotification(e) {
          let { result: t, subscription: r } = (0, b.Ue)(e, t7);
          this._handleServerNotification(r, [t.value, t.context]);
        }
        _wsOnSlotNotification(e) {
          let { result: t, subscription: r } = (0, b.Ue)(e, tb);
        ...
        _wsOnSlotUpdatesNotification(e) {
          let { result: t, subscription: r } = (0, b.Ue)(e, tk);
          this._handleServerNotification(r, [t]);
        }
        onSlotUpdate(e) {
          return this._makeSubscription(
        ...
        _wsOnSignatureNotification(e) {
          let { result: t, subscription: r } = (0, b.Ue)(e, tw);
        ...
        _wsOnRootNotification(e) {
          let { result: t, subscription: r } = (0, b.Ue)(e, tS);
          this._handleServerNotification(r, [t]);
        }
        onRootChange(e) {
          return this._makeSubscription(
      ...
      class rr {
        ...
        static fromSecretKey(e, t) {
          ...
          return new rr({ publicKey: r, secretKey: e });
        }
        static fromSeed(e) {
          let t = A(e),
            r = new Uint8Array(64);
          return r.set(e), r.set(t, 32), new rr({ publicKey: t, secretKey: r });
        }
        get publicKey() {
      ...
      let ri = Object.freeze({
        ...
        FreezeLookupTable: { index: 1, layout: f.n_([f.Jq("instruction")]) },
        ExtendLookupTable: {
          index: 2,
          layout: f.n_([
            f.Jq("instruction"),
            eb(),
            f.A9(z(), f.cv(f.Jq(), -8), "addresses"),
          ]),
        },
        ...
        CloseLookupTable: { index: 4, layout: f.n_([f.Jq("instruction")]) },
      });
      class rs {
        constructor() {}
        static createLookupTable(e) {
          let [t, r] = W.findProgramAddressSync(
              [e.authority.toBuffer(), (0, m.k$)(BigInt(e.recentSlot), 8)],
              this.programId
            ),
            i = ed(ri.CreateLookupTable, {
            ...
            s = [
              ...
              { pubkey: ek.programId, isSigner: !1, isWritable: !1 },
            ];
          return [new Y({ programId: this.programId, keys: s, data: i }), t];
        }
        static freezeLookupTable(e) {
          let t = ed(ri.FreezeLookupTable),
            r = [
              { pubkey: e.lookupTable, isSigner: !1, isWritable: !0 },
              { pubkey: e.authority, isSigner: !0, isWritable: !1 },
            ];
          return new Y({ programId: this.programId, keys: r, data: t });
        }
        static extendLookupTable(e) {
          let t = ed(ri.ExtendLookupTable, {
          ...
          return (
            ...
            new Y({ programId: this.programId, keys: r, data: t })
          );
        }
        static deactivateLookupTable(e) {
          let t = ed(ri.DeactivateLookupTable),
            r = [
              { pubkey: e.lookupTable, isSigner: !1, isWritable: !0 },
              { pubkey: e.authority, isSigner: !0, isWritable: !1 },
            ];
      ...
      rs.programId = new W("AddressLookupTab1e1111111111111111111111111");
      let rn = Object.freeze({
        ...
        RequestHeapFrame: {
          index: 1,
          layout: f.n_([f.u8("instruction"), f.Jq("bytes")]),
        },
        SetComputeUnitLimit: {
          index: 2,
          layout: f.n_([f.u8("instruction"), f.Jq("units")]),
        },
        SetComputeUnitPrice: {
          index: 3,
          layout: f.n_([f.u8("instruction"), eb("microLamports")]),
        },
      });
      class ro {
        constructor() {}
        static requestUnits(e) {
          let t = ed(rn.RequestUnits, e);
          return new Y({ keys: [], programId: this.programId, data: t });
        }
        static requestHeapFrame(e) {
          let t = ed(rn.RequestHeapFrame, e);
          return new Y({ keys: [], programId: this.programId, data: t });
        }
        static setComputeUnitLimit(e) {
          let t = ed(rn.SetComputeUnitLimit, e);
          return new Y({ keys: [], programId: this.programId, data: t });
        }
        static setComputeUnitPrice(e) {
          let t = ed(rn.SetComputeUnitPrice, {
            microLamports: BigInt(e.microLamports),
          });
          return new Y({ keys: [], programId: this.programId, data: t });
        }
      }
      ro.programId = new W("ComputeBudget111111111111111111111111111111");
      let ra = f.n_([
        f.u8("numSignatures"),
        f.u8("padding"),
        f.KB("signatureOffset"),
        f.KB("signatureInstructionIndex"),
        f.KB("publicKeyOffset"),
        f.KB("publicKeyInstructionIndex"),
        f.KB("messageDataOffset"),
        f.KB("messageDataSize"),
        f.KB("messageInstructionIndex"),
      ]);
      class rc {
        constructor() {}
        static createInstructionWithPublicKey(e) {
          ...
          return (
            ...
            u.fill(i, o),
            u.fill(r, c),
            new Y({ keys: [], programId: rc.programId, data: u })
          );
        }
      ...
      rc.programId = new W("Ed25519SigVerify111111111111111111111111111");
      let ru = (e, t) => {
        let r = _.secp256k1.sign(e, t);
        return [r.toCompactRawBytes(), r.recovery];
      };
      _.secp256k1.utils.isValidPrivateKey;
      let rl = _.secp256k1.getPublicKey,
        rd = f.n_([
          f.u8("numSignatures"),
          f.KB("signatureOffset"),
          f.u8("signatureInstructionIndex"),
          f.KB("ethAddressOffset"),
      ...
      class rh {
        ...
        static publicKeyToEthAddress(e) {
          ...
          try {
            return a.Buffer.from((0, S.fr)(R(e))).slice(-20);
          } catch (e) {
        ...
        static createInstructionWithPublicKey(e) {
          ...
          return rh.createInstructionWithEthAddress({
            ethAddress: rh.publicKeyToEthAddress(t),
            message: r,
            signature: i,
            recoveryId: s,
            instructionIndex: n,
        ...
        static createInstructionWithEthAddress(e) {
          ...
          let c = 12 + t.length,
            u = c + s.length + 1,
            l = a.Buffer.alloc(rd.span + i.length);
          return (
            rd.encode(
              {
                numSignatures: 1,
            ...
            l.fill(R(i), rd.span),
            new Y({ keys: [], programId: rh.programId, data: l })
          );
        }
        static createInstructionWithPrivateKey(e) {
          let { privateKey: t, message: r, instructionIndex: i } = e;
      ...
      rh.programId = new W("KeccakSecp256k11111111111111111111111111111");
      let rg = new W("StakeConfig11111111111111111111111111111111");
      class rp {
        constructor(e, t, r) {
      ...
      rp.default = new rp(0, 0, W.default);
      let rf = Object.freeze({
        Initialize: {
          index: 0,
          layout: f.n_([
            f.Jq("instruction"),
            ((e = "authorized") => f.n_([z("staker"), z("withdrawer")], e))(),
            ((e = "lockup") =>
              f.n_(
                [f.gM("unixTimestamp"), f.gM("epoch"), z("custodian")],
                e
              ))(),
          ]),
        },
        Authorize: {
          ...
          layout: f.n_([
            f.Jq("instruction"),
            z("newAuthorized"),
            f.Jq("stakeAuthorizationType"),
          ]),
        },
        Delegate: { index: 2, layout: f.n_([f.Jq("instruction")]) },
        Split: {
          index: 3,
          layout: f.n_([f.Jq("instruction"), f.gM("lamports")]),
        },
        ...
        Deactivate: { index: 5, layout: f.n_([f.Jq("instruction")]) },
        Merge: { index: 7, layout: f.n_([f.Jq("instruction")]) },
        AuthorizeWithSeed: {
          index: 8,
          layout: f.n_([
            f.Jq("instruction"),
      ...
      class rm {
        ...
        static delegate(e) {
          ...
          return new ee().add({
            keys: [
              ...
              { pubkey: eo, isSigner: !1, isWritable: !1 },
              { pubkey: rg, isSigner: !1, isWritable: !1 },
        ...
        static authorize(e) {
          let {
            ...
            a = [
              { pubkey: t, isSigner: !1, isWritable: !0 },
              { pubkey: ei, isSigner: !1, isWritable: !0 },
              { pubkey: r, isSigner: !0, isWritable: !1 },
            ];
          return (
            n && a.push({ pubkey: n, isSigner: !0, isWritable: !1 }),
            new ee().add({ keys: a, programId: this.programId, data: o })
          );
        }
        static authorizeWithSeed(e) {
          ...
          return (
            ...
            new ee().add({ keys: u, programId: this.programId, data: c })
          );
        }
      ...
      (rm.programId = new W("Stake11111111111111111111111111111111111111")),
        (rm.space = 200);
      ...
      class ry {
        ...
        static updateValidatorIdentity(e) {
          let {
            ...
            s = ed(rb.UpdateValidatorIdentity);
          return new ee().add({
            keys: [
              { pubkey: t, isSigner: !1, isWritable: !0 },
              { pubkey: i, isSigner: !0, isWritable: !1 },
      ...
      (ry.programId = new W("Vote111111111111111111111111111111111111111")),
        (ry.space = 3762),
        new W("Va1idator1nfo111111111111111111111111111111"),
        (0, b.dt)({
          name: (0, b.Z_)(),
          website: (0, b.jt)((0, b.Z_)()),
          details: (0, b.jt)((0, b.Z_)()),
          iconUrl: (0, b.jt)((0, b.Z_)()),
          keybaseUsername: (0, b.jt)((0, b.Z_)()),
        }),
        new W("Vote111111111111111111111111111111111111111"),
        f.n_([
          z("nodePubkey"),
          z("authorizedWithdrawer"),
          f.u8("commission"),
          f._O(),
          f.A9(
            f.n_([f._O("slot"), f.Jq("confirmationCount")]),
            f.cv(f.Jq(), -8),
            "votes"
          ),
          f.u8("rootSlotValid"),
          ...
          f._O(),
          f.A9(
            f.n_([f._O("epoch"), z("authorizedVoter")]),
            f.cv(f.Jq(), -8),
            "authorizedVoters"
          ),
          f.n_(
            [
              f.A9(
                f.n_([
                  z("authorizedPubkey"),
                  f._O("epochOfLastAuthorizedSwitch"),
                  f._O("targetEpoch"),
                ]),
                32,
                "buf"
          ...
          f._O(),
          f.A9(
            f.n_([f._O("epoch"), f._O("credits"), f._O("prevCredits")]),
            f.cv(f.Jq(), -8),
            "epochCredits"
          ),
          f.n_([f._O("slot"), f._O("timestamp")], "lastTimestamp"),
        ]);
      let rk = 1e9;
    },
  },
